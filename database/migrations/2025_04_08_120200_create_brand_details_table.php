...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('brand_details', function (Blueprint $table) {
            ...
            $table->string('brand_name')->comment('Nama merek yang diajukan');
            $table->text('brand_description')->comment('Deskripsi rinci tentang merek yang diajukan');
            $table->string("inovators_name")->comment('Nama inovator yang mengajukan permohonan merek');
